...
public class ListaDoble<T> implements Iterable<T> {
	...
	public void intercambiarNodosPorValores(T valor1, T valor2) {
		NodoDoble<T> nodo1 = buscarNodo(valor1);
		NodoDoble<T> nodo2 = buscarNodo(valor2);

		if (nodo1 != null && nodo2 != null) {
			// Intercambiar los valores de los nodos
			T temp = nodo1.getValorNodo();
			nodo1.setValorNodo(nodo2.getValorNodo());
			nodo2.setValorNodo(temp);
		} else {
			throw new RuntimeException("Al menos uno de los valores no existe en la lista");
		}
	}
